...
import {
  ...
  Sparkles, Users, TrendingUp, Lock, Star,
} from 'lucide-react';
...
export default function Registar() {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-background">
      ...
      {/* ══════════════════════════════════════════════
           ESTILOS — 100% idênticos ao Login e Landing
         ══════════════════════════════════════════════ */}
      <style>{`
        @keyframes shimmer       { 0%{background-position:-200% center} 100%{background-position:200% center} }
        ...
        /* Foto — idêntica ao Login / Landing hero */
        ...
        /* Força de senha */
        .pw-strength-bar { height:3px; border-radius:99px; transition:width .4s ease,background .4s ease; }
      `}</style>

      {/* ══════════════════════════════════════════════
           PAINEL ESQUERDO — foto + glass + badges
         ══════════════════════════════════════════════ */}
      <div className="hidden lg:flex lg:w-[48%] xl:w-[50%] relative flex-col reg-panel-l overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-10 xl:p-14">
          ...
          <div className="my-auto">
            <div className="inline-flex items-center gap-2 glass-pill rounded-full px-4 py-2 mb-7 cursor-default">
              ...
              <span className="text-xs font-bold text-white tracking-wide">Comece a faturar hoje mesmo</span>
            ...
            <h2 className="font-black text-white mb-4 leading-[.88]"
              ...
              Junte-se às<br />
              <span className="shimmer-white">melhores empresas.</span>
            </h2>
            ...
            {/* Testemunho — glass-stat */}
            
            {/* Features */}
            <div className="flex flex-col gap-2.5">
              {[
                { icon:Zap,       label:'Grátis para começar, sem cartão'  },
        ...
        {/* Floating badges — idênticos ao Login e Landing */}
        ...
        <div className="w-full max-w-sm py-6">
          ...
          <div className="fu-1 mb-7">
            ...
            <p className="text-muted-foreground text-sm">
              Registe-se gratuitamente e comece a faturar agora
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="fu-2 space-y-1.5">
              ...
              <Input
                ...
                className={`auth-input ${focused==='nome' ? 'border-primary/55 !bg-background shadow-[0_0_0_3px_hsl(var(--primary)/.12)]' : ''}`}
              />
            </div>
            ...
            <div className="fu-3 space-y-1.5">
              ...
              <Input
                ...
                required disabled={loading}
                className={`auth-input ${focused==='email' ? 'border-primary/55 !bg-background shadow-[0_0_0_3px_hsl(var(--primary)/.12)]' : ''}`}
              />
            </div>

            {/* Palavra-passe + Confirmar — grid 2 colunas */}
            <div className="fu-4 grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  required disabled={loading}
                  className={`auth-input ${focused==='confirmPassword' ? 'border-primary/55 !bg-background shadow-[0_0_0_3px_hsl(var(--primary)/.12)]' : ''}`}
                />
              </div>
            </div>
            ...
            {password.length > 0 && (
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-muted-foreground">
                  {password.length < 6 ? 'Fraca — mínimo 6 caracteres'
                    : password.length < 8 ? 'Razoável — tente mais caracteres'
                    : /[A-Z]/.test(password) && /[0-9]/.test(password) ? 'Muito forte ✓'
                    : 'Boa — adicione maiúsculas e números'}
                </p>
              </div>
            )}
            ...
            <div className="fu-5 pt-1">
              ...
              >
                {loading ? (
                  ...
                  <>Criar Conta Grátis <ArrowRight className="h-4 w-4 group-hover:translate-x-1.5 transition-transform" /></>
                )}
              </Button>
            </div>
          </form>
